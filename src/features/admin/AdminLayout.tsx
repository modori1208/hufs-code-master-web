...
const AdminProblemEditPage = lazy(() => import('@/features/admin/pages/AdminProblemEditPage'));
const AdminTracksPage = lazy(() => import('@/features/admin/pages/AdminTracksPage'));
const AdminTrackEditPage = lazy(() => import('@/features/admin/pages/AdminTrackEditPage'));
