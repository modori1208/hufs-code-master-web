...
// react-markdown + remark + rehype + katex가 함께 200KB+ 가 되므로 메인 번들에서 분리합니다.
// main.tsx가 부팅 후 idle 시점에 './MarkdownInner' 를 prefetch 해서 캐시에 미리 올려둡니다.
  ...
  return (
    <div
      className={cn(
        ...
        // prose의 자체 light/dark 매핑 (prose-invert)은 우리 토큰과 충돌하므로 쓰지 않음.
